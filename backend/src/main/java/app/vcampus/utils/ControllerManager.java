...
public class ControllerManager {
    ...
    public ControllerManager() {
        ...
        routeMapping.registerRoute(("shop/QRbuy"), storeController::QRbuy);//二维码购买
        routeMapping.registerRoute(("shop/cartBuy"), ShoppingCartController::handleCartPurchase);//购物车购买
